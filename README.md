...
- Presents a performance overview built off the dynamic trial balance: direct revenue/expense cards, a COGS card (Opening Stock + Purchases – Closing Stock), gross profit (Revenue – Direct Expense – COGS), indirect income/expense cards, and a net profit rollup based on **T2Dynamic CLB** totals.
