...
- Builds a Dynamic Trial Balance from Day Book + Ledger + Group masters with user-entered date ranges, showing dynamic opening/closing balances and offering an Excel download.
