...
- Provides quick **Profit & Loss** and **Balance Sheet** statement buttons (on the Table tab) that slice the dynamic trial balance without exposing the full table on-screen.
